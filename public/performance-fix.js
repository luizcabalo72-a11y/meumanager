/* =========================================================
   ...
   ? Anti-loop: garante que execute apenas 1 vez
...
(function () {
  ...
  // ? Trava global (se script carregar 2x, ignora)
  if (window.__PERFORMANCE_FIX_LOADED__) {
    // console.debug("?? performance-fix.js j? carregado, ignorando duplicate");
    return;
  }
  window.__PERFORMANCE_FIX_LOADED__ = true;
  ...
  console.log("? Performance optimizations loaded (once)");
})();
